...
LT_DEFINE_CLASS(LT_StackFrameObject) {
    ...
    .name = "StackFrame",
    .documentation = "Abstract stack frame captured for diagnostics.",
...
LT_DEFINE_CLASS(LT_EvalStackFrame) {
    ...
    .metaclass_superclass = &LT_Class_class,
    .name = "EvalStackFrame",
    .documentation = "Stack frame for evaluation of a source form.",
...
LT_DEFINE_CLASS(LT_ApplyStackFrame) {
    ...
    .documentation = "Stack frame for applying a callable value.",
